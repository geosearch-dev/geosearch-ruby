...
module GeoSearch
  class IPResultCountry < ApiModelBase
    attr_accessor :iso_code

    attr_accessor :name

    attr_accessor :is_in_european_union
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GeoSearch::IPResultCountry` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GeoSearch::IPResultCountry`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_in_european_union')
        self.is_in_european_union = attributes[:'is_in_european_union']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          iso_code == o.iso_code &&
          name == o.name &&
          is_in_european_union == o.is_in_european_union
    end
    ...
    def hash
      [iso_code, name, is_in_european_union].hash
    end
