  ...
  class City < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GeoSearch::City` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GeoSearch::City`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'admin1_code')
        self.admin1_code = attributes[:'admin1_code']
      end

      if attributes.key?(:'admin2_code')
        self.admin2_code = attributes[:'admin2_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          admin1_code == o.admin1_code &&
          admin2_code == o.admin2_code &&
    ...
    def hash
      [id, geoname_id, name, ascii_name, country_code, admin1_code, admin2_code, population, elevation, timezone, latitude, longitude, country, region].hash
    end
