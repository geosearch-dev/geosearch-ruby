...
module GeoSearch
  class PostalCode < ApiModelBase
    ...
    attr_accessor :admin_name1

    attr_accessor :admin_code1

    attr_accessor :admin_name2

    attr_accessor :admin_code2

    attr_accessor :admin_name3

    attr_accessor :admin_code3
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GeoSearch::PostalCode` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GeoSearch::PostalCode`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'admin_name1')
        self.admin_name1 = attributes[:'admin_name1']
      end

      if attributes.key?(:'admin_code1')
        self.admin_code1 = attributes[:'admin_code1']
      end

      if attributes.key?(:'admin_name2')
        self.admin_name2 = attributes[:'admin_name2']
      end

      if attributes.key?(:'admin_code2')
        self.admin_code2 = attributes[:'admin_code2']
      end

      if attributes.key?(:'admin_name3')
        self.admin_name3 = attributes[:'admin_name3']
      end

      if attributes.key?(:'admin_code3')
        self.admin_code3 = attributes[:'admin_code3']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          admin_name1 == o.admin_name1 &&
          admin_code1 == o.admin_code1 &&
          admin_name2 == o.admin_name2 &&
          admin_code2 == o.admin_code2 &&
          admin_name3 == o.admin_name3 &&
          admin_code3 == o.admin_code3 &&
          latitude == o.latitude &&
    ...
    def hash
      [id, country_code, postal_code, place_name, admin_name1, admin_code1, admin_name2, admin_code2, admin_name3, admin_code3, latitude, longitude, accuracy, country].hash
    end
