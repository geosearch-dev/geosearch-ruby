...
module GeoSearch
  class IPResult < ApiModelBase
    ...
    attr_accessor :is_anonymous_proxy

    attr_accessor :is_satellite_provider
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GeoSearch::IPResult` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GeoSearch::IPResult`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_anonymous_proxy')
        self.is_anonymous_proxy = attributes[:'is_anonymous_proxy']
      end

      if attributes.key?(:'is_satellite_provider')
        self.is_satellite_provider = attributes[:'is_satellite_provider']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          postal == o.postal &&
          location == o.location &&
          is_anonymous_proxy == o.is_anonymous_proxy &&
          is_satellite_provider == o.is_satellite_provider
    end
    ...
    def hash
      [ip, network, continent, country, region, city, postal, location, is_anonymous_proxy, is_satellite_provider].hash
    end
