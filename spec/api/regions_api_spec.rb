...
# Unit tests for GeoSearch::RegionsApi
...
describe 'RegionsApi' do
  ...
  describe 'test an instance of RegionsApi' do
    it 'should create an instance of RegionsApi' do
      expect(@api_instance).to be_instance_of(GeoSearch::RegionsApi)
    end
  end
  ...
  # unit tests for list_region_cities
  ...
  describe 'list_region_cities test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for region_children
  ...
  # @option opts [String] :fields Comma-separated list of fields to include in the response
  # @return [CityListResponse]
  describe 'region_children test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
