...
# Unit tests for GeoSearch::PostalCodesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PostalCodesApi' do
  before do
  ...
  describe 'test an instance of PostalCodesApi' do
    it 'should create an instance of PostalCodesApi' do
      expect(@api_instance).to be_instance_of(GeoSearch::PostalCodesApi)
    end
  end

  # unit tests for list_postal_codes
  # List postal codes
  ...
  describe 'list_postal_codes test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for nearest_postal_code
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [String] :lang ISO 639-1 language code for localized names (e.g., de, fr, ja)
  # @option opts [Integer] :limit Number of results (1-10, default 1)
  # @return [PostalCodeListResponse]
  describe 'nearest_postal_code test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
