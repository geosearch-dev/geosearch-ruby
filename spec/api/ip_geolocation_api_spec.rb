...
# Unit tests for GeoSearch::IPGeolocationApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IPGeolocationApi' do
  before do
  ...
  describe 'test an instance of IPGeolocationApi' do
    it 'should create an instance of IPGeolocationApi' do
      expect(@api_instance).to be_instance_of(GeoSearch::IPGeolocationApi)
    end
  end

  # unit tests for lookup_ip
  ...
  describe 'lookup_ip test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for lookup_my_ip
