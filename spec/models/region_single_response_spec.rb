...
# Unit tests for GeoAPI::RegionSingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::RegionSingleResponse do
  #let(:instance) { GeoAPI::RegionSingleResponse.new }

  describe 'test an instance of RegionSingleResponse' do
    it 'should create an instance of RegionSingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::RegionSingleResponse)
    end
  end
