...
# Unit tests for GeoSearch::RegionSingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::RegionSingleResponse do
  #let(:instance) { GeoSearch::RegionSingleResponse.new }

  describe 'test an instance of RegionSingleResponse' do
    it 'should create an instance of RegionSingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::RegionSingleResponse)
    end
  end
