...
# Unit tests for GeoSearch::IPResultCity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::IPResultCity do
  #let(:instance) { GeoSearch::IPResultCity.new }

  describe 'test an instance of IPResultCity' do
    it 'should create an instance of IPResultCity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::IPResultCity)
    end
  end
