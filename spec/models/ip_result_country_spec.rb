...
# Unit tests for GeoAPI::IPResultCountry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::IPResultCountry do
  #let(:instance) { GeoAPI::IPResultCountry.new }

  describe 'test an instance of IPResultCountry' do
    it 'should create an instance of IPResultCountry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::IPResultCountry)
    end
  end
