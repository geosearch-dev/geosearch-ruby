...
# Unit tests for GeoSearch::IPResultCountry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::IPResultCountry do
  #let(:instance) { GeoSearch::IPResultCountry.new }

  describe 'test an instance of IPResultCountry' do
    it 'should create an instance of IPResultCountry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::IPResultCountry)
    end
  end
  ...
  describe 'test attribute "is_in_european_union"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
