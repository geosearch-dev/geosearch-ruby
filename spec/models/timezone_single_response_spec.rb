...
# Unit tests for GeoSearch::TimezoneSingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::TimezoneSingleResponse do
  #let(:instance) { GeoSearch::TimezoneSingleResponse.new }

  describe 'test an instance of TimezoneSingleResponse' do
    it 'should create an instance of TimezoneSingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::TimezoneSingleResponse)
    end
  end
