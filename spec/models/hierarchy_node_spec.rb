...
# Unit tests for GeoAPI::HierarchyNode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::HierarchyNode do
  #let(:instance) { GeoAPI::HierarchyNode.new }

  describe 'test an instance of HierarchyNode' do
    it 'should create an instance of HierarchyNode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::HierarchyNode)
    end
  end
