...
# Unit tests for GeoSearch::HierarchyNode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::HierarchyNode do
  #let(:instance) { GeoSearch::HierarchyNode.new }

  describe 'test an instance of HierarchyNode' do
    it 'should create an instance of HierarchyNode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::HierarchyNode)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["city", "region", "country", "continent"])
