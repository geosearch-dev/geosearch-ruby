...
# Unit tests for GeoSearch::GetStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::GetStatus200Response do
  #let(:instance) { GeoSearch::GetStatus200Response.new }

  describe 'test an instance of GetStatus200Response' do
    it 'should create an instance of GetStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::GetStatus200Response)
    end
  end
