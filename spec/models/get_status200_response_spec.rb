...
# Unit tests for GeoAPI::GetStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::GetStatus200Response do
  #let(:instance) { GeoAPI::GetStatus200Response.new }

  describe 'test an instance of GetStatus200Response' do
    it 'should create an instance of GetStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::GetStatus200Response)
    end
  end
