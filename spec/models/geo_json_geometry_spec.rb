...
# Unit tests for GeoSearch::GeoJSONGeometry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::GeoJSONGeometry do
  #let(:instance) { GeoSearch::GeoJSONGeometry.new }

  describe 'test an instance of GeoJSONGeometry' do
    it 'should create an instance of GeoJSONGeometry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::GeoJSONGeometry)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Polygon", "MultiPolygon"])
