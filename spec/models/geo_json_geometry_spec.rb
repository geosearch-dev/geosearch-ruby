...
# Unit tests for GeoAPI::GeoJSONGeometry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::GeoJSONGeometry do
  #let(:instance) { GeoAPI::GeoJSONGeometry.new }

  describe 'test an instance of GeoJSONGeometry' do
    it 'should create an instance of GeoJSONGeometry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::GeoJSONGeometry)
    end
  end
