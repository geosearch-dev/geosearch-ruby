...
# Unit tests for GeoAPI::GetStatus200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::GetStatus200ResponseData do
  #let(:instance) { GeoAPI::GetStatus200ResponseData.new }
  ...
  describe 'test an instance of GetStatus200ResponseData' do
    it 'should create an instance of GetStatus200ResponseData' do
      ...
      #expect(instance).to be_instance_of(GeoAPI::GetStatus200ResponseData)
    end
  end
