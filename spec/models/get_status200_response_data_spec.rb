...
# Unit tests for GeoSearch::GetStatus200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::GetStatus200ResponseData do
  #let(:instance) { GeoSearch::GetStatus200ResponseData.new }

  describe 'test an instance of GetStatus200ResponseData' do
    it 'should create an instance of GetStatus200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::GetStatus200ResponseData)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["healthy", "degraded"])
  ...
  describe 'test attribute "database"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["connected", "disconnected"])
      # validator.allowable_values.each do |value|
