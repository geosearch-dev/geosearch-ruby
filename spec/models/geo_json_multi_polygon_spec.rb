...
# Unit tests for GeoSearch::GeoJSONMultiPolygon
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::GeoJSONMultiPolygon do
  #let(:instance) { GeoSearch::GeoJSONMultiPolygon.new }

  describe 'test an instance of GeoJSONMultiPolygon' do
    it 'should create an instance of GeoJSONMultiPolygon' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::GeoJSONMultiPolygon)
    end
  end
