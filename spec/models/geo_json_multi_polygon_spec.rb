...
# Unit tests for GeoAPI::GeoJSONMultiPolygon
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::GeoJSONMultiPolygon do
  #let(:instance) { GeoAPI::GeoJSONMultiPolygon.new }

  describe 'test an instance of GeoJSONMultiPolygon' do
    it 'should create an instance of GeoJSONMultiPolygon' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::GeoJSONMultiPolygon)
    end
  end
