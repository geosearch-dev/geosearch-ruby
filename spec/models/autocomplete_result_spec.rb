...
# Unit tests for GeoSearch::AutocompleteResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::AutocompleteResult do
  #let(:instance) { GeoSearch::AutocompleteResult.new }

  describe 'test an instance of AutocompleteResult' do
    it 'should create an instance of AutocompleteResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::AutocompleteResult)
    end
  end
