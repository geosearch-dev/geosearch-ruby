...
# Unit tests for GeoSearch::TimezoneListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::TimezoneListResponse do
  #let(:instance) { GeoSearch::TimezoneListResponse.new }

  describe 'test an instance of TimezoneListResponse' do
    it 'should create an instance of TimezoneListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::TimezoneListResponse)
    end
  end
