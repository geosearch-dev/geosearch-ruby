...
# Unit tests for GeoAPI::TimezoneListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::TimezoneListResponse do
  #let(:instance) { GeoAPI::TimezoneListResponse.new }

  describe 'test an instance of TimezoneListResponse' do
    it 'should create an instance of TimezoneListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::TimezoneListResponse)
    end
  end
