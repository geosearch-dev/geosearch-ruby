...
# Unit tests for GeoSearch::CountryListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::CountryListResponse do
  #let(:instance) { GeoSearch::CountryListResponse.new }

  describe 'test an instance of CountryListResponse' do
    it 'should create an instance of CountryListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::CountryListResponse)
    end
  end
