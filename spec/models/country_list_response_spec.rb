...
# Unit tests for GeoAPI::CountryListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::CountryListResponse do
  #let(:instance) { GeoAPI::CountryListResponse.new }

  describe 'test an instance of CountryListResponse' do
    it 'should create an instance of CountryListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::CountryListResponse)
    end
  end
