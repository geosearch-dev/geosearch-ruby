...
# Unit tests for GeoAPI::ErrorResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::ErrorResponseError do
  #let(:instance) { GeoAPI::ErrorResponseError.new }

  describe 'test an instance of ErrorResponseError' do
    it 'should create an instance of ErrorResponseError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::ErrorResponseError)
    end
  end
