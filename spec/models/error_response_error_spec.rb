...
# Unit tests for GeoSearch::ErrorResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::ErrorResponseError do
  #let(:instance) { GeoSearch::ErrorResponseError.new }

  describe 'test an instance of ErrorResponseError' do
    it 'should create an instance of ErrorResponseError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::ErrorResponseError)
    end
  end
