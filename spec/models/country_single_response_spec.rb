...
# Unit tests for GeoSearch::CountrySingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::CountrySingleResponse do
  #let(:instance) { GeoSearch::CountrySingleResponse.new }

  describe 'test an instance of CountrySingleResponse' do
    it 'should create an instance of CountrySingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::CountrySingleResponse)
    end
  end
