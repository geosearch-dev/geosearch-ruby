...
# Unit tests for GeoAPI::CountrySingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::CountrySingleResponse do
  #let(:instance) { GeoAPI::CountrySingleResponse.new }

  describe 'test an instance of CountrySingleResponse' do
    it 'should create an instance of CountrySingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::CountrySingleResponse)
    end
  end
