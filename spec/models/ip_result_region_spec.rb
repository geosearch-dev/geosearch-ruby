...
# Unit tests for GeoAPI::IPResultRegion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::IPResultRegion do
  #let(:instance) { GeoAPI::IPResultRegion.new }

  describe 'test an instance of IPResultRegion' do
    it 'should create an instance of IPResultRegion' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::IPResultRegion)
    end
  end
