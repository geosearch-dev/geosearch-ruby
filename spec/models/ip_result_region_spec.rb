...
# Unit tests for GeoSearch::IPResultRegion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::IPResultRegion do
  #let(:instance) { GeoSearch::IPResultRegion.new }

  describe 'test an instance of IPResultRegion' do
    it 'should create an instance of IPResultRegion' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::IPResultRegion)
    end
  end
