...
# Unit tests for GeoSearch::CountryRef
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::CountryRef do
  #let(:instance) { GeoSearch::CountryRef.new }

  describe 'test an instance of CountryRef' do
    it 'should create an instance of CountryRef' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::CountryRef)
    end
  end
