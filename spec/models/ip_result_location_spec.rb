...
# Unit tests for GeoAPI::IPResultLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::IPResultLocation do
  #let(:instance) { GeoAPI::IPResultLocation.new }

  describe 'test an instance of IPResultLocation' do
    it 'should create an instance of IPResultLocation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::IPResultLocation)
    end
  end
