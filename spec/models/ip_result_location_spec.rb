...
# Unit tests for GeoSearch::IPResultLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::IPResultLocation do
  #let(:instance) { GeoSearch::IPResultLocation.new }

  describe 'test an instance of IPResultLocation' do
    it 'should create an instance of IPResultLocation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::IPResultLocation)
    end
  end
