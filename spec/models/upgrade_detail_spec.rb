...
# Unit tests for GeoAPI::UpgradeDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::UpgradeDetail do
  #let(:instance) { GeoAPI::UpgradeDetail.new }

  describe 'test an instance of UpgradeDetail' do
    it 'should create an instance of UpgradeDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::UpgradeDetail)
    end
  end
