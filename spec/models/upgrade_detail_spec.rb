...
# Unit tests for GeoSearch::UpgradeDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::UpgradeDetail do
  #let(:instance) { GeoSearch::UpgradeDetail.new }

  describe 'test an instance of UpgradeDetail' do
    it 'should create an instance of UpgradeDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::UpgradeDetail)
    end
  end

  describe 'test attribute "upgrade_url"' do
    it 'should work' do
