...
# Unit tests for GeoSearch::Boundary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::Boundary do
  #let(:instance) { GeoSearch::Boundary.new }

  describe 'test an instance of Boundary' do
    it 'should create an instance of Boundary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::Boundary)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["country", "region"])
  ...
  describe 'test attribute "simplify"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
