...
# Unit tests for GeoSearch::BoundarySingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::BoundarySingleResponse do
  #let(:instance) { GeoSearch::BoundarySingleResponse.new }

  describe 'test an instance of BoundarySingleResponse' do
    it 'should create an instance of BoundarySingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::BoundarySingleResponse)
    end
  end
