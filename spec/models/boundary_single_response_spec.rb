...
# Unit tests for GeoAPI::BoundarySingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::BoundarySingleResponse do
  #let(:instance) { GeoAPI::BoundarySingleResponse.new }

  describe 'test an instance of BoundarySingleResponse' do
    it 'should create an instance of BoundarySingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::BoundarySingleResponse)
    end
  end
