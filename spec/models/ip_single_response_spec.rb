...
# Unit tests for GeoAPI::IPSingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::IPSingleResponse do
  #let(:instance) { GeoAPI::IPSingleResponse.new }

  describe 'test an instance of IPSingleResponse' do
    it 'should create an instance of IPSingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::IPSingleResponse)
    end
  end
