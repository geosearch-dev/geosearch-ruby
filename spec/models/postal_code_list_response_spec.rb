...
# Unit tests for GeoAPI::PostalCodeListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::PostalCodeListResponse do
  #let(:instance) { GeoAPI::PostalCodeListResponse.new }

  describe 'test an instance of PostalCodeListResponse' do
    it 'should create an instance of PostalCodeListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::PostalCodeListResponse)
    end
  end
