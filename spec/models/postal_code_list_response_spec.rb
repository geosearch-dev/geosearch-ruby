...
# Unit tests for GeoSearch::PostalCodeListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::PostalCodeListResponse do
  #let(:instance) { GeoSearch::PostalCodeListResponse.new }

  describe 'test an instance of PostalCodeListResponse' do
    it 'should create an instance of PostalCodeListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::PostalCodeListResponse)
    end
  end
