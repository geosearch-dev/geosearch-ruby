...
# Unit tests for GeoAPI::PaginationMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::PaginationMeta do
  #let(:instance) { GeoAPI::PaginationMeta.new }

  describe 'test an instance of PaginationMeta' do
    it 'should create an instance of PaginationMeta' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::PaginationMeta)
    end
  end
