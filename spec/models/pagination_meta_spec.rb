...
# Unit tests for GeoSearch::PaginationMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::PaginationMeta do
  #let(:instance) { GeoSearch::PaginationMeta.new }

  describe 'test an instance of PaginationMeta' do
    it 'should create an instance of PaginationMeta' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::PaginationMeta)
    end
  end
  ...
  describe 'test attribute "prev_cursor"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
