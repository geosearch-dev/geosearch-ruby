...
# Unit tests for GeoSearch::Timezone
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::Timezone do
  #let(:instance) { GeoSearch::Timezone.new }

  describe 'test an instance of Timezone' do
    it 'should create an instance of Timezone' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::Timezone)
    end
  end
  ...
  describe 'test attribute "dst_offset"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "raw_offset"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
