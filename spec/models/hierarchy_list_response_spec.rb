...
# Unit tests for GeoAPI::HierarchyListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::HierarchyListResponse do
  #let(:instance) { GeoAPI::HierarchyListResponse.new }

  describe 'test an instance of HierarchyListResponse' do
    it 'should create an instance of HierarchyListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::HierarchyListResponse)
    end
  end
