...
# Unit tests for GeoSearch::ReverseGeocodeSingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::ReverseGeocodeSingleResponse do
  #let(:instance) { GeoSearch::ReverseGeocodeSingleResponse.new }

  describe 'test an instance of ReverseGeocodeSingleResponse' do
    it 'should create an instance of ReverseGeocodeSingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::ReverseGeocodeSingleResponse)
    end
  end
