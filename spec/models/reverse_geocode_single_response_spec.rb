...
# Unit tests for GeoAPI::ReverseGeocodeSingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::ReverseGeocodeSingleResponse do
  #let(:instance) { GeoAPI::ReverseGeocodeSingleResponse.new }
  ...
  describe 'test an instance of ReverseGeocodeSingleResponse' do
    it 'should create an instance of ReverseGeocodeSingleResponse' do
      ...
      #expect(instance).to be_instance_of(GeoAPI::ReverseGeocodeSingleResponse)
    end
  end
