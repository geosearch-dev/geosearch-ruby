...
# Unit tests for GeoSearch::ReverseGeocodeResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::ReverseGeocodeResult do
  #let(:instance) { GeoSearch::ReverseGeocodeResult.new }

  describe 'test an instance of ReverseGeocodeResult' do
    it 'should create an instance of ReverseGeocodeResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::ReverseGeocodeResult)
    end
  end
