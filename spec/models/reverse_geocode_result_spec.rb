...
# Unit tests for GeoAPI::ReverseGeocodeResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::ReverseGeocodeResult do
  #let(:instance) { GeoAPI::ReverseGeocodeResult.new }

  describe 'test an instance of ReverseGeocodeResult' do
    it 'should create an instance of ReverseGeocodeResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::ReverseGeocodeResult)
    end
  end
