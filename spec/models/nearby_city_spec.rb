...
# Unit tests for GeoSearch::NearbyCity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::NearbyCity do
  #let(:instance) { GeoSearch::NearbyCity.new }

  describe 'test an instance of NearbyCity' do
    it 'should create an instance of NearbyCity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::NearbyCity)
    end
  end
