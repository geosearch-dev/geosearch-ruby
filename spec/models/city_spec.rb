...
# Unit tests for GeoSearch::City
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::City do
  #let(:instance) { GeoSearch::City.new }

  describe 'test an instance of City' do
    it 'should create an instance of City' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::City)
    end
  end
  ...
  describe 'test attribute "admin1_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "admin2_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
