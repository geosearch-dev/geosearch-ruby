...
# Unit tests for GeoAPI::NearbyCityListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::NearbyCityListResponse do
  #let(:instance) { GeoAPI::NearbyCityListResponse.new }

  describe 'test an instance of NearbyCityListResponse' do
    it 'should create an instance of NearbyCityListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::NearbyCityListResponse)
    end
  end
