...
# Unit tests for GeoSearch::NearbyCityListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::NearbyCityListResponse do
  #let(:instance) { GeoSearch::NearbyCityListResponse.new }

  describe 'test an instance of NearbyCityListResponse' do
    it 'should create an instance of NearbyCityListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::NearbyCityListResponse)
    end
  end
