...
# Unit tests for GeoSearch::IPResultPostal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::IPResultPostal do
  #let(:instance) { GeoSearch::IPResultPostal.new }

  describe 'test an instance of IPResultPostal' do
    it 'should create an instance of IPResultPostal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::IPResultPostal)
    end
  end
