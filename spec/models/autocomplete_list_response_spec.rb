...
# Unit tests for GeoSearch::AutocompleteListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::AutocompleteListResponse do
  #let(:instance) { GeoSearch::AutocompleteListResponse.new }

  describe 'test an instance of AutocompleteListResponse' do
    it 'should create an instance of AutocompleteListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::AutocompleteListResponse)
    end
  end
