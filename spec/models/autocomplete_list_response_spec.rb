...
# Unit tests for GeoAPI::AutocompleteListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::AutocompleteListResponse do
  #let(:instance) { GeoAPI::AutocompleteListResponse.new }
  ...
  describe 'test an instance of AutocompleteListResponse' do
    it 'should create an instance of AutocompleteListResponse' do
      ...
      #expect(instance).to be_instance_of(GeoAPI::AutocompleteListResponse)
    end
  end
