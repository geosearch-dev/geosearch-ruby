...
# Unit tests for GeoAPI::ErrorResponseErrorDetailsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::ErrorResponseErrorDetailsInner do
  #let(:instance) { GeoAPI::ErrorResponseErrorDetailsInner.new }
  ...
  describe 'test an instance of ErrorResponseErrorDetailsInner' do
    it 'should create an instance of ErrorResponseErrorDetailsInner' do
      ...
      #expect(instance).to be_instance_of(GeoAPI::ErrorResponseErrorDetailsInner)
    end
  end
