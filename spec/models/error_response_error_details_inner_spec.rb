...
# Unit tests for GeoSearch::ErrorResponseErrorDetailsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::ErrorResponseErrorDetailsInner do
  #let(:instance) { GeoSearch::ErrorResponseErrorDetailsInner.new }

  describe 'test an instance of ErrorResponseErrorDetailsInner' do
    it 'should create an instance of ErrorResponseErrorDetailsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::ErrorResponseErrorDetailsInner)
    end
  end
