...
# Unit tests for GeoAPI::RegionListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::RegionListResponse do
  #let(:instance) { GeoAPI::RegionListResponse.new }

  describe 'test an instance of RegionListResponse' do
    it 'should create an instance of RegionListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::RegionListResponse)
    end
  end
