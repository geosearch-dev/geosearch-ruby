...
# Unit tests for GeoSearch::SearchListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::SearchListResponse do
  #let(:instance) { GeoSearch::SearchListResponse.new }

  describe 'test an instance of SearchListResponse' do
    it 'should create an instance of SearchListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::SearchListResponse)
    end
  end
