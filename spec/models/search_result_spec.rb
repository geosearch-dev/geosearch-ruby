...
# Unit tests for GeoSearch::SearchResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::SearchResult do
  #let(:instance) { GeoSearch::SearchResult.new }

  describe 'test an instance of SearchResult' do
    it 'should create an instance of SearchResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::SearchResult)
    end
  end
