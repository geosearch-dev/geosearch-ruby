...
# Unit tests for GeoAPI::SearchResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::SearchResult do
  #let(:instance) { GeoAPI::SearchResult.new }

  describe 'test an instance of SearchResult' do
    it 'should create an instance of SearchResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::SearchResult)
    end
  end
