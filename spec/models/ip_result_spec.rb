...
# Unit tests for GeoSearch::IPResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::IPResult do
  #let(:instance) { GeoSearch::IPResult.new }

  describe 'test an instance of IPResult' do
    it 'should create an instance of IPResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::IPResult)
    end
  end
  ...
  describe 'test attribute "is_anonymous_proxy"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "is_satellite_provider"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
