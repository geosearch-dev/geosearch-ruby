...
# Unit tests for GeoAPI::BatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::BatchRequest do
  #let(:instance) { GeoAPI::BatchRequest.new }

  describe 'test an instance of BatchRequest' do
    it 'should create an instance of BatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::BatchRequest)
    end
  end
