...
# Unit tests for GeoSearch::BatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::BatchRequest do
  #let(:instance) { GeoSearch::BatchRequest.new }

  describe 'test an instance of BatchRequest' do
    it 'should create an instance of BatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::BatchRequest)
    end
  end
