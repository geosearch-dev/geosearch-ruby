...
# Unit tests for GeoAPI::CityListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::CityListResponse do
  #let(:instance) { GeoAPI::CityListResponse.new }

  describe 'test an instance of CityListResponse' do
    it 'should create an instance of CityListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::CityListResponse)
    end
  end
