...
# Unit tests for GeoAPI::CitySingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::CitySingleResponse do
  #let(:instance) { GeoAPI::CitySingleResponse.new }

  describe 'test an instance of CitySingleResponse' do
    it 'should create an instance of CitySingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::CitySingleResponse)
    end
  end
