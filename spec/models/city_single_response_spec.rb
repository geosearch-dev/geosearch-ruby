...
# Unit tests for GeoSearch::CitySingleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::CitySingleResponse do
  #let(:instance) { GeoSearch::CitySingleResponse.new }

  describe 'test an instance of CitySingleResponse' do
    it 'should create an instance of CitySingleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::CitySingleResponse)
    end
  end
