...
# Unit tests for GeoAPI::QuotaDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::QuotaDetail do
  #let(:instance) { GeoAPI::QuotaDetail.new }

  describe 'test an instance of QuotaDetail' do
    it 'should create an instance of QuotaDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::QuotaDetail)
    end
  end
