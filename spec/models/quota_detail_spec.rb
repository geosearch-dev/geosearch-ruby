...
# Unit tests for GeoSearch::QuotaDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::QuotaDetail do
  #let(:instance) { GeoSearch::QuotaDetail.new }

  describe 'test an instance of QuotaDetail' do
    it 'should create an instance of QuotaDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::QuotaDetail)
    end
  end
