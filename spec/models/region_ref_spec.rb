...
# Unit tests for GeoSearch::RegionRef
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::RegionRef do
  #let(:instance) { GeoSearch::RegionRef.new }

  describe 'test an instance of RegionRef' do
    it 'should create an instance of RegionRef' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::RegionRef)
    end
  end
