...
# Unit tests for GeoAPI::IPResultContinent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoAPI::IPResultContinent do
  #let(:instance) { GeoAPI::IPResultContinent.new }

  describe 'test an instance of IPResultContinent' do
    it 'should create an instance of IPResultContinent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoAPI::IPResultContinent)
    end
  end
