...
# Unit tests for GeoSearch::IPResultContinent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GeoSearch::IPResultContinent do
  #let(:instance) { GeoSearch::IPResultContinent.new }

  describe 'test an instance of IPResultContinent' do
    it 'should create an instance of IPResultContinent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GeoSearch::IPResultContinent)
    end
  end
